package net.gnomecraft.crosspollination.composter;
...
public class CrossPollinationCompostMoreItems {
    public static void init() {
        CrossPollinationConfig config = CrossPollination.getConfig();
